...
class linux:
    def install():
        ...
        installdirDefault = "/opt/rohankishore/schemix"
        ...
        os.system(f"ln -sf {installdir}/main {lnDir}/schemix")

        print("Creating desktop shortcuts...")
        os.system(f"cp schemix.desktop {deskDir}/schemix.desktop")
        os.system(f"sed -i 's#@INSTALLDIR@#{installdir}#g' {deskDir}/schemix.desktop")
